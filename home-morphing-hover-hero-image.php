...
<head>
	...
	<title>DarkStar | Home | Morphing Hover Hero Image</title>
...
<body class="sk__homepage sk__home-morphing-hover-hero dark-shade-1-bg">
	...
	<?php  include_once("includes/header.php") ?>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				<!-- Hero Section - Morphing Hero Image
				================================================== -->
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item zooming active hero-slide-1 sk__hero-slider-item sk__image-back-cover">
								...
								<section class="sk__hero-item-center-center">
									...
									<!-- Hero content -->
									<div class="mb-2 text-center sk__morphing-hover-hero-content">
										<span class="animated-element phase-1"></span>
										<span class="animated-element phase-1"></span>
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1">Morphing Hover is Here</h1>
										</div>
										<div class="cover-text-wrapper">
											<h2 class="h2-regular thin animated-element phase-1">Now <strong>Hover the Background</strong> to see the Morphing Hover Image Effect.</h2>
										</div>
										<div class="cover-text-wrapper">
									...
									<!-- Morphing images overlay -->
									<span class="animated-element phase-1"></span>
									<div class="sk__morphing-hover-hero-overlay sk__absolute animated-element phase-1"></div>
				...
				<!-- Browsers Selection
				================================================== -->
				<section class="sk__browsers-section sk__image-back-cover sk__pt-l sk__solid-menu-bar">
							...
							<div class="col sk__heading-spacer-l">
								<div class="cover-text-wrapper">
									<div class="fancy-gradient-text-box reveal-onscroll">
										<h1 class="super-heading sk__gradient-fancy-text mb-2 mb-sm-0 mb-xxl-2">Complete Style</h1>
									</div>
								</div>
								<div class="sk__reveal-all-wrapped-text">
									<div class="cover-text-wrapper">
										<p class="p-super">Not simply adapted for mobile layout, every layout was carefully designed from scratch.</p>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="container sk__powercontainer">
						<div class="row">
							<div class="col">
								<div class="sk__browsers-wrapper" >
									<div class="sk__browsers-tablet sk__image-back-cover"></div>
									<div class="sk__browsers-desktop sk__image-back-cover"></div>
									<div class="sk__browsers-phone sk__image-back-cover"></div>
								</div>
							</div>
						</div>
					</div>
	...
	<script type="text/javascript">
		...
		new hoverEffect({
			parent: document.querySelector('.sk__home-morphing-hover-hero .sk__morphing-hover-hero-container'),
			intensity: 0.4,
			image1: 'assets/images/morphing-hero-image-01-crop.webp',
			image2: 'assets/images/morphing-hero-image-02-crop.webp',
