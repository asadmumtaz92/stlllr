...
<head>
	...
	<title>DarkStar | Portfolio Item Page | Classic</title>
	...
	<?php  include_once("includes/header.php") ?>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				================================================== -->
				<section class="sk__gallery-basic-thumbnails">

					<div class="container sk__powercontainer">
						<div class="row">
							<div class="col-12 col-md-10 offset-md-1 text-center sk__heading-spacer-m">
								...
								<h2 class="h2-regular">Classic-style Project Gallery with Beautiful & Clean Look</h2>
							</div>
						</div>
						<div class="row">
							<div class="col">
								...
								<div id="sk__project-1-gallery-basic" class="carousel slide">
									...
									<!-- Arrows Bootstrap 5 -->
									<button class="carousel-control-prev" type="button" data-bs-target="#sk__project-1-gallery-basic" data-bs-slide="prev">
										<span class="carousel-control-prev-icon" aria-hidden="true"></span>
										<span class="visually-hidden">Previous</span>
									</button>
									<button class="carousel-control-next" type="button" data-bs-target="#sk__project-1-gallery-basic" data-bs-slide="next">
						...
						<div class="row sk__heading-spacer-l mt-5">
							<div class="col-12 col-xl-10 offset-xl-1 text-center">
								<h1 class="h1-small mb-3 pt-4 pb-1">Our projects speak volumes</h1>
								<p class="p-v2 skills-subhead">Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante. Sed lacinia, urna non tincidunt mattis, tortor neque adipiscing diam, a cursus ipsum ante quis turpis. Nulla facilisi. Ut fringilla. Suspendisse potenti. Nunc feugiat mi a tellus consequat imperdiet. Vestibulum sapien. Proin quam. Etiam ultrices. Suspendisse in justo eu magna luctus suscipit. Nulla facilisi. Ut fringilla. Suspendisse potenti. Nunc feugiat mi a tellus consequat imperdiet, a cursus ipsum ante quis turpis urna non tincidunt mattis, tortor neque adipiscing. Super set of datapass envision ecstasy in salven state mystic beauty.</p>
							</div>
						</div>
					</div>
