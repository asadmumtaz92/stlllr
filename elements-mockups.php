...
<body class="sk__homepage sk__elements-mockups-page dark-shade-1-bg">
	...
	<?php  include_once("includes/header.php") ?>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				<!-- Browsers Selection
				================================================== -->
				<section class="sk__browsers-section sk__image-back-cover sk__pt-l mt-5 mt-sm-0 sk__solid-menu-bar">
					<div class="container sk__supercontainer">
						<div class="row text-center">
							<div class="col">
								<div class="cover-text-wrapper">
									<div class="fancy-gradient-text-box reveal-onscroll">
										<h1 class="super-heading sk__gradient-fancy-text mb-2 mb-sm-0 mb-md-5 mb-lg-0 mb-xxl-2">Premium Mockups</h1>
									</div>
								</div>
							</div>
						</div>
