...
<head>
	...
	<title>DarkStar | Elements | Hero Animated Headline</title>
										...
										<div class="cover-text-wrapper">
											<h1 class="super-heading sk__animated-headline animated-element phase-1 mb-0">
												...
												<span class="sk__animated-headline-words">
													<span class="sk__visible sk__clipped-text sk__gradient-back-v1" data-sk-animated-words="DarkStar,Creative,Innovative,Dedicated">Animated</span>
												</span>
											</h1>
										</div>
										<div class="cover-text-wrapper">
											<h2 class="h2-regular thin animated-element phase-1">Super-easy to create, unlimited words and instances. Works with all types of text.</h2>
										</div>
										<div class="cover-text-wrapper">
