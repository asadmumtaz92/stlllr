...
<head>
	...
	<meta property="og:image" content="assets/images/facebook-post-image-browsers.jpg"/>

	<meta property="og:site_name" content="SkilltechWebDesign.com"/>

	<title>DarkStar | Home | Parallax Strips Hero</title>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
					...
					<div id="sk__hero-carousel-slider" class="sk__static-carousel-slider carousel slide dark-shade-1-bg">
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item active hero-slide-1 sk__hero-slider-item sk__image-back-cover">
								...
								<div class="sk__hero-parallax-strip-vertical sk__image-back-cover" data-sk-speed="1" style="background-image: url(assets/images/parallax-strip-01.webp);"></div>
								<div class="sk__hero-parallax-strip-vertical sk__image-back-cover" data-sk-speed="3" style="background-image: url(assets/images/parallax-strip-02.jpg);"></div>
								<div class="sk__hero-parallax-strip-vertical sk__image-back-cover" data-sk-speed="5" style="background-image: url(assets/images/parallax-strip-03.webp);"></div>
								<div class="sk__hero-parallax-strip-vertical sk__image-back-cover" data-sk-speed="7" style="background-image: url(assets/images/parallax-strip-04.webp);"></div>
								<div class="sk__hero-parallax-strip-vertical sk__image-back-cover" data-sk-speed="8" style="background-image: url(assets/images/parallax-strip-05.webp);"></div>
								<div class="sk__hero-parallax-strip-vertical sk__image-back-cover" data-sk-speed="10" style="background-image: url(assets/images/parallax-strip-06.webp);"></div>

								<div class="sk__tint sk__absolute sk__z0"></div>
								...
								<section class="sk__parallax-background-section sk__hero-item-theme-style">
									...
									<div class="hero-h1-box">
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Multi<br /> Parallax<br /> Strips</h1>
										</div>
									</div>
									...
									<div class="hero-box-bottom-left text-center text-sm-start">
										...
										<div class="cover-text-wrapper">
											<h3 class="animated-element phase-1 text-center text-sm-start text-white">INDEPENDENT <strong>SPEEDS</strong></h3>
										</div>
				...
				<section class="sk__rings-section sk__image-back-cover dark-shade-1-bg overflow-hidden">
					...
					<!-- parallax area -->
					<div id="sk__parallax-layers-1" class="container sk__full-height position-relative">
						<!-- gradient ring 1 -->
				...
				<!-- Features section
				================================================== -->
				<section class="sk__features-section sk__py-l sk__edge-beauty position-relative">
				...
				<!-- Services Section
				================================================== -->
				<section id="services" class="sk__services-section sk__parallax-background-section sk__py-l dark-shade-5-border sk__solid-menu-bar">
