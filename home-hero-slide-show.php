...
<head>
	...
	<title>DarkStar | Home | Hero Slide Show</title>
...
<body class="sk__homepage sk__home-hero-slideshow dark-shade-1-bg">
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item zooming active hero-slide-1 sk__hero-slider-item sk__image-back-cover">
								...
								<section class="sk__parallax-background-section sk__hero-item-theme-style">
									...
									<!-- Parallax background -->
									<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/hero-image-06.webp);"></div>
							...
							<div class="carousel-item zooming hero-slide-2 sk__hero-slider-item sk__image-back-cover">
								...
								<section class="sk__parallax-background-section sk__hero-item-theme-style">
									...
									<!-- Parallax background -->
									<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/hero-image-02.webp);"></div>
									...
									<div class="hero-h1-box">
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Dark<br /> Shaped<br /> Perfection</h1>
										</div>
									</div>
									...
									<div class="hero-box-bottom-left text-center text-sm-start">
										...
										<a class="btn btn-gradient-outline animated-element phase-1 mb-4" href="#about-us" role="button">OPEN PROJECT</a>
