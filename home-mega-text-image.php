...
<head>
	...
	<meta property="og:image" content="assets/images/facebook-post-image-mask-2.jpg"/>

	<meta property="og:site_name" content="SkilltechWebDesign.com"/>

	<title>DarkStar | Home | Mega Text Image</title>
...
<body class="sk__homepage sk__home-mega-text-image dark-shade-1-bg">
					...
					<div id="sk__hero-carousel-slider" class="sk__static-carousel-slider carousel slide dark-shade-1-bg">
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item zooming active hero-slide-1 sk__hero-slider-item sk__image-back-cover">
								...
								<section class="sk__mega-image-text-section sk__parallax-background-section"><!-- sk__hero-item-theme-style -->
									<!-- Parallax background -->
									<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/hero-image-05.webp);"></div>

									<div class="sk__image-and-text-fusion sk__absolute sk__flex-center dark-shade-1-bg">
