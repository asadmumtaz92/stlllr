...
<head>
	...
	<title>DarkStar | Elements | Hero Image</title>
...
<body class="sk__elements-hero-image-page dark-shade-1-bg">
								...
								<section class="sk__parallax-background-section sk__hero-item-theme-style">
									...
									<div class="hero-h1-box">
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Hero<br /> Image<br /> Section</h1>
										</div>
									</div>
