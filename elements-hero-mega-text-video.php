...
<head>
	...
	<title>DarkStar | Elements | Hero Mega Text Video</title>
...
<body class="sk__elements-hero-mega-text-video-page dark-shade-1-bg">
	...
	<?php  include_once("includes/header.php") ?>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				================================================== -->
				<section class="sk__hero-section sk__mega-video-text-section sk__parallax-background-section sk__parallax-fixer-section">
