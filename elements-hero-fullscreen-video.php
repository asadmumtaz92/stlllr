...
<head>
	...
	<title>DarkStar | Elements | Fullscreen Video</title>
...
<body class="sk__fullscreen-video-page dark-shade-1-bg">
								...
								<section class="sk__video-background-section sk__hero-item-theme-style">
									...
									<div class="hero-h1-box">
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Fullscreen<br /> Hero<br /> Video</h1>
										</div>
									</div>
