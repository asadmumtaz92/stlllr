...
<head>
	...
	<title>DarkStar | Home | News</title>
...
<body class="sk__homepage sk__home-news dark-shade-1-bg">
	...
	<?php  include_once("includes/header.php") ?>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item zooming active hero-slide-1 sk__hero-slider-item sk__image-back-cover">
								<section class="sk__parallax-background-section sk__hero-item-center-center">
									<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/news-home-hero-image-01.jpg);"></div>
									<div class="sk__tint-light sk__absolute sk__z0"></div>
									...
									<div class="mb-2 text-center">
										...
										<div class="cover-text-wrapper">
											<h2 class="h2-super animated-element phase-1">Skilltech breaks the mould of Web Design & Graphic Design</h2>
										</div>
										<div class="cover-text-wrapper">
											<h3 class="h3-super thin animated-element phase-1">Salvia vape blue bottle bespoke wolf celiac quinoa cloud bread letterpress hammock.</h3>
										</div>
									</div>
							...
							<div class="carousel-item zooming hero-slide-2 sk__hero-slider-item sk__image-back-cover">
								<section class="sk__parallax-background-section sk__hero-item-center-center">
									<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/news-home-hero-image-02.webp);"></div>
									<div class="sk__tint-light sk__absolute sk__z0"></div>
									...
									<div class="mb-2 text-center">
										...
										<span class="animated-element phase-1"></span>
										<div class="cover-text-wrapper">
											<h2 class="h2-super animated-element phase-1">Unraveling the mysteries of powerful effects in Web Design.</h2>
										</div>
										<div class="cover-text-wrapper">
											<h3 class="h3-super thin animated-element phase-1">Salvia vape blue bottle bespoke wolf celiac quinoa cloud bread letterpress hammock.</h3>
										</div>
							...
							<div class="carousel-item zooming hero-slide-3 sk__hero-slider-item sk__image-back-cover">
								<section class="sk__parallax-background-section sk__hero-item-center-center">
									<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/news-home-hero-image-03.jpg);"></div>
									<div class="sk__tint-light sk__absolute sk__z0"></div>
									...
									<div class="mb-2 text-center">
										...
										<span class="animated-element phase-1"></span>
										<div class="cover-text-wrapper">
											<h2 class="h2-super animated-element phase-1">A casual view of the most influential aesthetic setting.</h2>
										</div>
										<div class="cover-text-wrapper">
											<h3 class="h3-super thin animated-element phase-1">Salvia vape blue bottle bespoke wolf celiac quinoa cloud bread letterpress hammock.</h3>
										</div>
							...
							<div class="carousel-item zooming hero-slide-4 sk__hero-slider-item sk__image-back-cover">
								<section class="sk__parallax-background-section sk__hero-item-center-center">
									<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/news-home-hero-image-04.webp);"></div>
									<div class="sk__tint-light sk__absolute sk__z0"></div>
									...
									<div class="mb-2 text-center">
										...
										<span class="animated-element phase-1"></span>
										<div class="cover-text-wrapper">
											<h2 class="h2-super animated-element phase-1">DarkStar news are here and they are amazing.</h2>
										</div>
										<div class="cover-text-wrapper">
											<h3 class="h3-super thin animated-element phase-1">Salvia vape blue bottle bespoke wolf celiac quinoa cloud bread letterpress hammock.</h3>
										</div>
				...
				<!-- News Body
				================================================== -->
				<section class="sk__blog-content sk__blog-main-content sk__blog-feed sk__blog-style-v1-magazine sk__py-s">
						...
						<div class="row">
							...
							<div class="col-12 sk__feed-col">
								...
								<div class="d-flex sk__articles-wrapper">
									...
									<!-- Article -->
									<div class="sk__blog-article-wrapper sk__fade-in-2">
