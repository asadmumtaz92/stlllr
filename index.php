					...
					<div class="container sk__supercontainer">
						<div class="row">
							<div class="col-12 col-lg-6 sk__rectangles-left about-left text-center text-sm-start">
								...
								<h2 class="h2-regular">Developing the future</h2>
								<p class="mw-440">We provide a wide range of services that will aid in the development and growth of your company. Our team of developers builds websites and mobile applications that effectively represent your company to your clients.</p>
							</div>
