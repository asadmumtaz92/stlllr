	...
	<main id="primary" class="site-main">
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				<?php include_once("includes/masive-ring.php") ?>
				...
				<?php include_once("includes/additional-services.php") ?>

				<!-- OUR FUTURE Services Section -->
				<?php include_once("includes/our-future-services.php") ?>
