...
<head>
	...
	<title>StlllR | Elements | Forms</title>
					...
					<div class="container sk__supercontainer">
						<div class="row text-center">
							<div class="col-12 col-md-10 offset-md-1 sk__reveal-header-text">
								...
								<div class="cover-text-wrapper">
									<h2 class="h2-large sk__heading-spacer-s">StlllR comes with fully working contact forms and subscribe forms. <strong>$14 added value</strong>!</h2>
								</div>
							</div>
						</div>
					</div>
