...
<head>
	...
	<title>DarkStar | Elements | Forms</title>
	...
	<?php  include_once("includes/header.php") ?>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
							...
							<div class="col-12 col-md-10 offset-md-1 sk__reveal-header-text">
								<div class="cover-text-wrapper">
									<div class="fancy-gradient-text-box">
										<h1 class="super-heading sk__gradient-fancy-text">Forms</h1>
									</div>
								</div>
								<div class="cover-text-wrapper">
									<h2 class="h2-large sk__heading-spacer-s">DarkStar comes with fully working contact forms and subscribe forms. <strong>$14 added value</strong>!</h2>
								</div>
							</div>
						</div>
					</div>
				...
				<!-- Contact Us Section
				================================================== -->
				<section id="contact-us" class="sk__contact-us sk__py-m sk__parallax-background-section sk__flex-center-y sk__fade-in-10">
					...
					<div class="container sk__powercontainer">
						...
						<div class="row sk__contact-info sk__inner-header text-center">
							<div class="col-12 col-lg-10 offset-lg-1">
								<h1 class="h1-small">Contact form</h1>
							</div>
						</div>
						<div class="row">
							<!-- Contact Form -->
				...
				<!-- Subscribe Section
				================================================== -->
				<section id="subscribe-form" class="sk__py-l">
					<div class="container sk__powercontainer">
						<!-- Section Header -->
						<div class="row sk__contact-info sk__inner-header text-center">
							<div class="col-12 col-lg-6 offset-lg-3">
								<h1 class="h1-small">Subscribe form</h1>
							</div>
						</div>
						<div class="row">
							<!-- Subscribe Form -->
							<div class="col-12 col-lg-6 offset-lg-3">
								<div class="sk__contact-right text-center">
									...
									<p>Easily insert subscribe forms wherever you need them.</p>
