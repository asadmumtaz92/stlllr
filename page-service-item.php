...
<head>
	...
	<title>DarkStar | Service Item Page</title>
	...
	<?php  include_once("includes/header.php") ?>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				<!-- Header Section
				================================================== -->
				<section class="sk__service-1-header sk__parallax-header sk__animated-header sk__header-y-l sk__service-header dark-shade-5-border">
					...
					<div class="container sk__supercontainer">
						...
						<div class="row sk__skills-row">
							<div class="col-12">
								...
								<div class="sk__skill-wrap">
									<p class="sk__skill-name sk__skill-el">Taps Into Entire Market</p>
									<div class="sk__skill-area sk__skill-el">
										<div class="sk__skill-bar sk__gradient-back-v1"></div>
									</div>
						...
						<div class="row mt-5">
							<div class="col text-center text-sm-start">
								<h4 class="h4-dark h4-shadow">See it in action.</h4>
								<span class="fat-divider dark-shade-4-bg"></span>
							</div>
						</div>
