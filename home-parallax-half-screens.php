...
<head>
	...
	<title>DarkStar | Home | Parallax Half-screen Images</title>
...
<body class="sk__homepage sk__home-parallax-halfscreen-images dark-shade-1-bg">
						...
						<div class="carousel-inner">
								...
								<section class="sk__parallax-background-section sk__hero-item-theme-style">
									...
									<div class="hero-h1-box">
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Parallax<br /> Super<br /> Charged</h1>
										</div>
									</div>
							...
							<div class="carousel-item zooming hero-slide-2 sk__hero-slider-item sk__image-back-cover">
								...
								<section class="sk__video-background-section sk__hero-item-theme-style">
									...
									<div class="hero-h1-box">
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Image<br /> & Video<br /> Parallax</h1>
										</div>
									</div>
							...
							<div class="carousel-item zooming hero-slide-3 sk__hero-slider-item sk__image-back-cover">
								<section class="sk__parallax-background-section sk__hero-item-theme-style">
									...
									<div class="hero-h1-box">
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Mouse<br /> Reactive<br /> Parallax</h1>
										</div>
									</div>
							...
							<div class="carousel-item zooming hero-slide-4 sk__hero-slider-item sk__image-back-cover">
								<section class="sk__parallax-background-section sk__hero-item-center-center">
									<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/hero-image-04.webp);"></div>
				...
				<section class="sk__halfscreen-section">
					<div class="container-fluid">
						<div class="row">
							<!-- Half-screen parallax image (right) -->
							<div class="order-xl-2 col-12 col-xl-6 sk__halfscreen-parallax-image-col sk__parallax-container">
								<img class="sk__parallax-element-3" alt="Example image as parallax background." src="assets/images/halfscreen-parallax-img-4.webp">
							</div>
							<!-- Half-screen text (left) -->
							<div class="col-12 col-xl-6 sk__halfscreen-text-col sk__flex-center-y text-center text-lg-end">
								<div class="sk__halfscreen-text-col-inner">
									<div class="cover-text-wrapper">
										<div class="fancy-gradient-text-box reveal-onscroll">
											<h3 class="h3-elegant sk__gradient-fancy-text">Make anything parallax!</h3>
										</div>
									</div>
									<h5 class="animated-element mw-660 me-lg-0 ms-lg-auto">Stylize your parallax elements with ready-made overlays.</h5>
									<p class="animated-element mw-560 me-lg-0 ms-lg-auto">Any image, any size, anywhere you like! Salvia vape blue bottle bespoke wolf celiac quinoa cloud bread letterpress hammock photo booth. Palo santo vexillologist venmo shaman pitchfork tote bag.</p>
									<a class="animated-element btn btn-outline-light mt-3" href="#" role="button">SOME LINK -></a>
								</div>
							</div>
