...
<head>
	...
	<title>DarkStar | News Page</title>
...
<body class="sk__news-page dark-shade-1-bg">
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				<section class="sk__news-header sk__parallax-container position-relative sk__header-t-m dark-shade-5-border">
					...
					<img class="sk__parallax-element-3 sk__fade-in-1" src="assets/images/news-hero-image.jpg" alt="Hero image.">
							...
							<div class="col-12 mb-5">
								<div class="cover-text-wrapper">
									<div class="fancy-gradient-text-box">
										<h1 class="super-heading sk__gradient-fancy-text">News are good.</h1>
									</div>
								</div>
								<h2 class="h2-large sk__fade-in-6">News are <strong>our friend</strong>, Mr Macelroy.</h2>
							</div>
						</div>
					</div>
											...
											<article class="post type-post format-standard has-post-thumbnail hentry">
												...
												<div class="sk__post-info py-4">
													<header class="entry-header">
														<h4 class="entry-title narrow gradient-links-bright"><a href="page-news-item.html" rel="bookmark">Load the Parallax Header style article preview. looks amazing on all displays and devices</a></h4>
													</header>
									...
									<div class="sk__blog-article-wrapper sk__fade-in-1">
										<div class="sk__article-magazine">
											<article class="post type-post format-standard has-post-thumbnail hentry">
												...
												<div class="sk__post-info py-4">
													<header class="entry-header">
														<h4 class="entry-title narrow gradient-links-bright"><a href="page-news-item.html" rel="bookmark">Load the Classic Header style article preview. looks amazing on all displays and devices</a></h4>
													</header>
													<div class="post-excerpt">
														<p>This is an example of how well designed layout cleans the page up and looks amazing on modern displays and devices. A splendid html template witness superior design.</p>
													</div>
