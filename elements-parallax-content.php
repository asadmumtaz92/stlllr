...
<head>
	...
	<title>StlllR | Elements | Parallax Content Sections</title>
					...
					<div class="container">
						<div class="row">
							<div class="col">
								...
								<h5 class="h5-large thin">With <strong>1500+</strong> icons to choose from in the StlllR custom IcoMoon font.</h5>
							</div>
						</div>
					</div>
				</section>
				...
				<section class="sk__parallax-background-section sk__parallax-fixer-ignore-height sk__pt-l sk__pb-m dark-shade-6-border sk__solid-menu-bar">
					...
					<div class="container pt-4">
						<div class="row sk__inner-header">
							<div class="col text-center">
								<h3 class="h3-super"><strong>StlllR Style</strong> Icon Boxes</h3>
							</div>
						</div>
