...
<head>
	...
	<meta property="og:image" content="assets/images/facebook-post-image-v2.jpg"/>

	<meta property="og:site_name" content="SkilltechWebDesign.com"/>

	<title>DarkStar | Home | Mega Text Video</title>
...
<body class="sk__homepage sk__home-mega-text-video dark-shade-1-bg">
	...
	<?php  include_once("includes/header.php") ?>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				================================================== -->
				<section class="sk__hero-section sk__mega-video-text-section sk__parallax-background-section sk__parallax-fixer-section" style="z-index: -1;">
					...
					<div class="sk__video-container sk__parallax-hero-video sk__absolute sk__image-back-cover">
						...
						<video class="sk__video" preload="none" poster="assets/video/hero-video-city.webp" autoplay="" loop="" muted="" playsinline="">
							<source src="assets/video/hero-video-city.mp4" type="video/mp4">Your browser does not support HTML5 video.
						</video>
					</div>
					<div class="sk__video-and-text-fusion sk__absolute sk__flex-center dark-shade-1-bg">
						<h1 class="h1-hero-mega-text unspaced">metafx</h1>
					</div>
				</section>
				<!-- /.sk__hero-section -->
					...
					<div class="container sk__supercontainer">
							...
							<div class="col text-center sk__heading-spacer-s">
								<div class="cover-text-wrapper">
									<div class="fancy-gradient-text-box reveal-onscroll">
										<h1 class="super-heading sk__gradient-fancy-text mb-2 mb-sm-0 mb-xxl-2">Superior Features</h1>
									</div>
								</div>
								<div class="cover-text-wrapper sk__reveal-all-wrapped-text">
									<h2 class="h2-large">There are <strong>No Limits</strong> for Darkstar.</h2>
								</div>
							</div>
						</div>
						<div class="row sk__featureboxes sk__featureboxes-image-style">
							<div class="col-sm-6 col-lg-3 sk__featurebox-col text-center">
						...
						<div class="row mt-5 sk__fade-in-2">
							<div class="col-12 col-xl-10 offset-xl-1 text-center">
								<p class="p-v2 skills-subhead">Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante. Sed lacinia, urna non tincidunt mattis, tortor neque adipiscing diam, a cursus ipsum ante quis turpis. Nulla facilisi. Salvia vape blue bottle bespoke wolf celiac quinoa cloud bread letterpress hammock photo booth. Palo santo vexillologist venmo shaman pitchfork tote bag.</p>
							</div>
						</div>
					</div>
				</section>
				...
				<!-- Portfolio Section
				================================================== -->
				<section class="sk__portfolio-section sk__py-l dark-shade-3-bg sk__solid-menu-bar">
					<div class="container-fluid">
				...
				<section class="sk__featured-project-section sk__parallax-background-section dark-shade-2-bg sk__flex sk__py-m">
