		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				<section class="sk__article-header sk__fade-in-3 sk__pt-m">
					...
					<div class="container sk__supercontainer sk__blog">
						<div class="row">
							<div class="col-12">
								<img class="mb-0 mb-lg-5 alignnone wp-image-2448 size-full" src="assets/images/article-1-header-cover.webp" alt="Man on the beach.">
							</div>
						</div>
					</div>
				...
				================================================== -->
				<div class="container sk__supercontainer sk__blog sk__fade-in-6 pt-3 pt-sm-5">
					<div class="row">
						...
						<div class="col-12 sk__single-article">
							...
							<article id="post-0333" class="post-0333 post type-post status-publish format-standard has-post-thumbnail hentry">
								<div class="post-content pb-5">
									...
									<h2 class="h2-large mb-4">Interesting read and <strong>Long Lasting Impression</strong>. Elegant news article page design.</h2>
