...
<head>
	...
	<title>DarkStar | Elements | Content Sections</title>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				<section class="sk__layered-parallax-header sk__full-height sk__flex-center dark-shade-6-border sk__z-1">
					...
					<div class="container sk__supercontainer sk__z1 sk__reveal-header-text">
						<div class="row text-center">
							<div class="col-12">
								<div class="cover-text-wrapper">
									<h1 class="super-heading mb-lg-0">Content Sections</h1>
								</div>
								<div class="cover-text-wrapper">
									<h2 class="h2-regular thin sk__heading-spacer-m">Ready for use, polished & clean looking content sections will help you build custom pages in minutes.</h2>
								</div>
							</div>
						</div>
					</div>
				...
				<section id="about-us-section" class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">About Us Section</h2>
							</div>
						</div>
					</div>
				</section>
				...
				<section id="animated-counters-section" class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">Animated Counters</h2>
							</div>
						</div>
					</div>
				</section>
				...
				<!-- Heading - CTA
				================================================== -->
				<section id="cta-section" class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-top border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">Call to Action <small>∙</small> CTA</h2>
				...
				<!-- Heading - Contact Us
				================================================== -->
				<section id="contact-section" class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-top border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">Contact Us Section</h2>
								<h5 class="h5-large thin">With real working forms. <strong>$14 Added Value!</strong> For parallax Contact section see Elements > Parallax Sections</h5>
							</div>
						</div>
					</div>
				</section>
				...
				<!-- Contact Us Section
				================================================== -->
				<section id="contact-us" class="sk__contact-us sk__py-m sk__image-back-cover sk__flex-center-y" style="position: relative; background-image: url(assets/images/contact-back.webp);">
					<div class="sk__tint sk__absolute" style="z-index: 0;"></div>
					<div class="container sk__powercontainer" style="z-index: 1;">
						<!-- Section Header -->
				...
				<!-- Heading - Features (Feature Boxes V1)
				================================================== -->
				<section id="features-section" class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-top border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">Features Section V1</h2>
							</div>
						</div>
					</div>
				</section>

				<!-- Features Section (Feature Boxes V1)
				================================================== -->
				...
				<!-- Feature Boxes V2 - Half-screen Style
				================================================== -->
				<section class="sk__features-section-v2 sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-top border-bottom">
					<div class="container sk__supercontainer">
						<div class="row text-center sk__features-section-v2-header">
							<div class="col-xxl-10 offset-xxl-1">
								<h2 class="h2-super">Features Section V2 - Half-screen</h2>
								<p class="p-super">Just an <strong><span class="sk__clipped-text sk__gradient-back-v1" style="font-weight: 800;">Awesome</span></strong> features section.</p>
							</div>
						</div>
					</div>
				</section>
				<!-- /.sk__features-section-v2 -->

				<section>
					<div class="container sk__supercontainer">
						<div class="row sk__py-l sk__featureboxes">
							<div class="col-lg-6 mb-4 text-center text-lg-start">
								<div class="cover-text-wrapper">
									<div class="fancy-gradient-text-box">
										<h1 class="super-heading sk__gradient-fancy-text mb-2 mb-sm-0 mb-xxl-2">Features</h1>
									</div>
								</div>
								<h2 class="h2-large sk__fade-in-6">With <strong>emphasized</strong> Headings.</h2>
							</div>
							<div class="col-6 col-sm-4 col-lg-2 sk__featurebox-col text-center">
								<div class="sk__featurebox">
									<div class="sk__featurebox-headwrap">
										<h4>Feature</h4>
									</div>
									<h5>Beautiful design form</h5>
								</div>
							</div>
							<div class="col-6 col-sm-4 col-lg-2 sk__featurebox-col text-center">
								<div class="sk__featurebox">
					...
					<div class="container sk__supercontainer">
						<div class="row sk__featureboxes">
							<div class="col text-center sk__heading-spacer-s">
								...
								<h2 class="h2-large sk__fade-in-6">Clean & beautiful <strong>image</strong> features.</h2>
							</div>
						</div>
						<div class="row sk__featureboxes sk__featureboxes-image-style">
							<div class="col-6 col-sm-4 col-lg-2 sk__featurebox-col text-center">
								<div class="sk__featurebox">
									<div class="sk__featurebox-headwrap sk__image-back-cover" style="background-image: url(assets/images/image-feature-01.webp);"></div>
									<h5>Beautiful design form</h5>
								</div>
							</div>
							<div class="col-6 col-sm-4 col-lg-2 sk__featurebox-col text-center">
								<div class="sk__featurebox">
									<div class="sk__featurebox-headwrap sk__image-back-cover" style="background-image: url(assets/images/image-feature-02.webp);"></div>
									<h5>Beautiful design form</h5>
								</div>
							</div>
							<div class="col-6 col-sm-4 col-lg-2 sk__featurebox-col text-center">
								<div class="sk__featurebox">
									<div class="sk__featurebox-headwrap sk__image-back-cover" style="background-image: url(assets/images/image-feature-03.webp);"></div>
									<h5>Beautiful design form</h5>
								</div>
							</div>
							<div class="col-6 col-sm-4 col-lg-2 sk__featurebox-col text-center">
								<div class="sk__featurebox">
									<div class="sk__featurebox-headwrap sk__image-back-cover" style="background-image: url(assets/images/image-feature-04.webp);"></div>
									<h5>Beautiful design form</h5>
								</div>
							</div>
							<div class="col-6 col-sm-4 col-lg-2 sk__featurebox-col text-center">
								<div class="sk__featurebox">
									<div class="sk__featurebox-headwrap sk__image-back-cover" style="background-image: url(assets/images/image-feature-05.webp);"></div>
									<h5>Beautiful design form</h5>
								</div>
							</div>
							<div class="col-6 col-sm-4 col-lg-2 sk__featurebox-col text-center">
								<div class="sk__featurebox">
									<div class="sk__featurebox-headwrap sk__image-back-cover" style="background-image: url(assets/images/image-feature-06.webp);"></div>
									<h5>Beautiful design form</h5>
								</div>
							</div>
						</div>
				...
				<!-- Feature Boxes V2 - Simple Style
				================================================== -->
				<section class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-top border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">Features Section V2 - Full Row</h2>
							</div>
						</div>
					</div>
				</section>
				...
				<!-- Heading - Icon boxes
				================================================== -->
				<section id="icon-boxes-section" class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-top border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">Icon Boxes</h2>
				...
				<section class="sk__pt-l pb-5 dark-shade-3-bg">
					<div class="container sk__supercontainer">
						<div class="row">
				...
				<!-- Heading - Image boxes
				================================================== -->
				<section id="image-boxes-section" class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-top border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">Image Boxes</h2>
							</div>
						</div>
					</div>
				</section>
				...
				================================================== -->
				<section id="partners-section" class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-top border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">Partners Section</h2>
							</div>
						</div>
					</div>
				</section>
				...
				<div class="sk__partners-section">
					<div class="container sk__supercontainer sk__py-m">
						<div class="row">
				...
				================================================== -->
				<section id="portfolio-section" class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-top border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">Portfolio Section</h2>
							</div>
						</div>
					</div>
				</section>
				...
				================================================== -->
				<section id="skills-section" class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-top border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">Skills Section</h2>
							</div>
						</div>
					</div>
				</section>
				...
				================================================== -->
				<section id="testimonials-section" class="sk__strip-header dark-shade-3-bg dark-shade-6-border text-center border-top border-bottom">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="h2-super">Testimonials Section</h2>
							</div>
						</div>
					</div>
				</section>
				...
				================================================== -->
				<section class="sk__testimonials-section sk__py-m">
					<div class="container sk__supercontainer">
						<div class="row">
							<div class="col">
								<div class="row mt-5">
