...
<head>
	...
	<title>DarkStar | Elements | Footer - Full</title>
			...
			<div id="smooth-content">
				...
				<section class="sk__parallax-header sk__animated-header sk__full-height sk__flex-center dark-shade-6-border">
					...
					<div class="container sk__supercontainer text-center">
						<div class="row">
							<div class="col-12">
								<h1 class="super-heading mb-lg-0">Footer - Full</h1>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-10 offset-lg-1">
								<h2 class="h2-regular thin sk__heading-spacer-m">This is the default footer across the theme, scroll down to see it.</h2>
							</div>
						</div>
					</div>
