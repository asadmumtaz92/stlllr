...
<head>
	...
	<title>DarkStar | Elements | Fullscreen YouTube Video</title>
								...
								<section class="sk__video-background-section sk__hero-item-theme-style">
									...
									<div class="hero-h1-box">
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Fullscreen<br /> YouTube<br /> Video</h1>
										</div>
									</div>
