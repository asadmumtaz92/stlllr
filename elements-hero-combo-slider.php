...
<head>
	...
	<title>DarkStar | Elements | Hero Combo Slider</title>
...
<body class="sk__elements-combo-slider-page dark-shade-1-bg">
						...
						<div class="carousel-inner">
								...
								<section class="sk__parallax-background-section sk__hero-item-theme-style">
									...
									<div class="hero-h1-box">
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Skilltech<br /> Combo<br /> Slider</h1>
										</div>
									</div>
							...
							<div class="carousel-item zooming hero-slide-2 sk__hero-slider-item sk__image-back-cover">
								...
								<section class="sk__video-background-section sk__hero-item-theme-style">
									...
									<div class="hero-h1-box">
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Images<br /> & Videos<br /> Combined</h1>
										</div>
									</div>
