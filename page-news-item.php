...
<head>
	...
	<title>DarkStar | News Item Page | Parallax Header</title>
...
<body class="sk__news-item-page dark-shade-1-bg">
	...
	<?php  include_once("includes/header.php") ?>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				<!-- Header Section
				================================================== -->
				<section class="sk__article-1-header sk__parallax-header sk__animated-header sk__header-y-l sk__article-header dark-shade-5-border mb-4">
					<div class="sk__parallax-header-image sk__absolute sk__image-back-cover sk__filter-city"></div>
					<div class="sk__tint-light sk__absolute"></div>

					<div class="container sk__supercontainer">
						<div class="row text-center">
							<div class="col-12">
								<h1 class="super-heading">Amazing article page design</h1>
				...
				<div class="container sk__supercontainer sk__blog sk__fade-in-10 pt-5">
					<div class="row">
						...
						<div class="col-12 sk__single-article">

							<article id="post-0333" class="post-0333 post type-post status-publish format-standard has-post-thumbnail hentry">
								<div class="post-content pb-5">

									<h2 class="h2-large">Let's start our story <strong>with a heading</strong>.</h2>

									<p>Retro leggings four loko pabst helvetica skateboard. Swag prism banjo glossier 90's readymade flannel. Everyday carry subway tile air plant enamel pin yr, single-origin coffee offal adaptogen tofu cloud bread edison bulb beard. Waistcoat affogato live-edge godard bushwick glossier, ethical beard dreamcatcher 90's stumptown readymade swag man bun. Adaptogen hell of street art wayfarers vexillologist copper mug ethical retro farm-to-table cardigan helvetica skateboard single-origin coffee hexagon. Marfa portland biodiesel, tote bag DSA trust fund raw denim cold-pressed skateboard dreamcatcher +1 mumblecore. Street art umami mustache man braid, art party normcore pinterest hella fixie.<br /> Pinterest drinking vinegar selfies lo-fi enamel pin cornhole butcher subway tile put a bird on it glossier. Sriracha lyft snackwave cred tonx blue bottle shoreditch 8-bit health goth tumeric banjo truffaut. Plaid wolf succulents, humblebrag swag brooklyn kale chips food truck kinfolk forage chartreuse shabby chic banh mi seitan. Glossier try-hard chambray vexillologist air plant schlitz narwhal iceland godard yes plz. Franzen vice DSA polaroid.</p>
									
									<h3 class="mt-5">Four loko pickled letterpress, thundercats kale chips.</h3>
									...
									<h3>Impressive Theme Design!</h3>
									
									<h5 class="mb-4">Superior dark theme is here.</h5>
									
									<p>Fashion axe organic biodiesel bicycle rights tilde hashtag actually cornhole yr portland flexitarian succulents brunch normcore palo santo. Health goth listicle plaid, activated charcoal mustache 3 wolf moon pour-over microdosing polaroid edison bulb green juice portland ennui. Intelligentsia portland irony selvage stumptown, small batch lo-fi poke YOLO thundercats crucifix banh mi chicharrones. Plaid narwhal tousled, actually viral sustainable twee taxidermy lo-fi tilde fashion axe raclette. Hexagon tattooed palo santo whatever tacos pop-up readymade, cold-pressed DIY pabst venmo +1 blog pok pok. Kale chips locavore blog raw denim waistcoat keffiyeh direct trade fanny pack craft beer. Bitters raclette yes plz, normcore XOXO snackwave occupy try-hard irony. <br />Franzen vexillologist thundercats, stumptown poke mlkshk salvia listicle pug mixtape. Yr pug gastropub man bun. Waistcoat mustache hexagon ugh, raclette skateboard salvia brooklyn banjo hoodie pour-over fam tumeric iPhone sartorial. Kinfolk pork belly farm-to-table jean shorts.</p>
									
									<h6 class="my-5"><strong>Skilltech Web Design</strong>&nbsp;Team</h6>
