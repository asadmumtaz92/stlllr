...
<head>
	...
	<title>DarkStar | Home | Combo Slider Light</title>
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item zooming hero-slide-2 sk__hero-slider-item sk__image-back-cover">
								...
								<section class="sk__video-background-section sk__hero-item-theme-style">
									...
									<div class="hero-h1-box">
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Videos<br /> & Images<br /> Slider</h1>
										</div>
									</div>
							...
							<div class="carousel-item zooming hero-slide-4 sk__hero-slider-item sk__image-back-cover">
								<section class="sk__parallax-background-section sk__hero-item-center-bottom">
									<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/hero-image-12.webp);"></div>

									<!-- Hero content -->
									<div class="mb-2 text-center sk__heading-spacer-m">
