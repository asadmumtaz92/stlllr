...
<head>
	...
	<title>DarkStar | Elements | Hero Parallax Strips</title>
...
<body class="sk__elements-parallax-strips-page dark-shade-1-bg">
	...
	<?php  include_once("includes/header.php") ?>
		...
		<nav id="main-nav" style="opacity: 0;" class="sk__menu navbar sk__navbar navbar-expand-lg navbar-dark static-top">
			...
			<ul class="navbar-nav ms-auto">
					...
					<ul class="sk__submenu-ul">
						...
						<li class="nav-item menu-item-has-children">
							...
							<ul class="sk__sub-submenu-ul">
								...
								<li class="nav-item"><a class="nav-link" href="elements-hero-animated-headline.html"><span class="sk__menu-icon"><span class="icon-view_week"></span></span>Animated Headline</a></li>
				...
				<li class="nav-item">
					<a class="nav-link hvr-underline-from-center" href="theme-preview.html"><span class="sk__menu-icon"><span class="icon-laptop1"></span></span>Demos</a>
				</li>
