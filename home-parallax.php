...
<head>
	...
	<title>DarkStar | Home | Parallax Style</title>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				<section id="about-us" class="sk__about-us-section sk__parallax-background-section sk__edge-beauty sk__py-xl">
					...
					<!-- Parallax background -->
					<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/parallax-background-section-01.webp); filter: sepia(0.8) hue-rotate(279deg) brightness(0.46) saturate(0.4) contrast(1.1);"></div>
				...
				<section class="sk__parallax-background-section sk__edge-beauty sk__flex-center sk__reveal-all-wrapped-text">
					...
					<div class="mb-5 pb-5 text-center">
						...
						<div class="cover-text-wrapper">
							<a class="btn btn-lg btn-outline-light" href="#" role="button">SOME LINK -></a>
						</div>
					</div>
				</section>
				...
				<section class="sk__featured-project-section sk__parallax-background-section dark-shade-2-bg sk__flex">
					<div class="sk__featured-project-background sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/featured-project-background-02.webp);"></div>
				...
				<!-- <section class="sk__full-height" style="background-color: purple;">
					
					<div id="sceneTwo">
						<div data-depth="0.07"><img src="assets/images/parallax-temp/Layer-1-Bakcground.webp"></div>
						<div data-depth="0.14"><img src="assets/images/parallax-temp/Layer-2.webp"></div>
						<div data-depth="0.21"><img src="assets/images/parallax-temp/Layer-3-Phone.webp"></div>
						<div data-depth="0.28"><img src="assets/images/parallax-temp/Layer-4-Parallax.webp"></div>
						<div data-depth="0.35" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;"><div style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; background-image: url(assets/images/parallax-temp/Layer-5-Over1.webp)"></div></div>
						<div data-depth="0.42"><img src="assets/images/parallax-temp/Layer-6-Over2.webp"></div>
					</div>
				...
				<!-- <section class="sk__parallax-background-section sk__centered-y-section">
					<div class="sk__parallax-background-element sk__absolute sk__image-back-cover sk__pbe-7"></div>
				</section>

				<section class="sk__parallax-background-section sk__centered-y-section">
					<div class="sk__parallax-background-element sk__absolute sk__image-back-cover sk__pbe-8"></div>
				</section> -->
