				...
				<div class="carousel-inner">
					...
					<div class="carousel-item zooming active hero-slide-1 sk__hero-slider-item sk__image-back-cover">
						...
						<section class="sk__parallax-background-section sk__hero-item-theme-style">
							...
							<!-- Parallax background -->
							< <div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/carousel_images/codding.webp); filter: blur(8px); -webkit-filter: blur(8px);"></div>
							...
							<div class="hero-h1-box">
								<div class="cover-text-wrapper">
									<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white">Website<br /> Development<br /> is Here</h1>
								</div>
							</div>
					...
					<!-- /.hero-slide-2 -->
						    ...
						    <div class="carousel-item zooming hero-slide-4 sk__hero-slider-item sk__image-back-cover">
								<section class="sk__parallax-background-section sk__hero-item-center-center">
									<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/carousel_images/mobile_app.webp); filter: blur(8px); -webkit-filter: blur(8px);"></div>
									...
									<div class="mb-2 text-center">
										...
										<div class="cover-text-wrapper">
											...
											<h1 class="hero-h1 animated-element phase-1" style="color: white">Mobile Apps Development</h1>
										</div>
										<div class="cover-text-wrapper">
											<h2 class="h2-regular thin animated-element phase-1" style="color: white">We develop cross platfor applications iOS, Android & Windows.</h2>
										</div>
										<div class="cover-text-wrapper">
