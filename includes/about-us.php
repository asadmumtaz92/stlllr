<?php
    ...
    echo '
        <section id="about-us" class="sk__about-us-section sk__py-xl" style="padding-bottom: 30px">
				...
				<div class="row row text-center text-sm-start">
					<div class="col-12 col-lg-6 sk__flex about-button-col order-2 order-lg-1">
						<div class="flex-child mb-3 mb-lg-0">
							<a class="btn btn-outline-light mb-4" href="#" role="button">OPEN PROJECT er</a>
						</div>
					</div>
