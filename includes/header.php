			...
			<ul class="navbar-nav ms-auto">
				...
				<li class="nav-item menu-item-has-children">
					...
					<ul class="sk__submenu-ul">
						<li class="nav-item"><a class="nav-link active" href="index.html"><span class="sk__menu-icon"><span
										class="icon-codepen1"></span></span>Combo Slider (<em>default</em>)</a></li>
						<li class="nav-item"><a class="nav-link" href="home-portfolio.html"><span class="sk__menu-icon"><span
										class="icon-th"></span></span>Portfolio Home</a></li>
						<li class="nav-item"><a class="nav-link" href="home-morphing-hover-hero-image.html"><span
									class="sk__menu-icon"><span class="icon-star"></span></span>Morphing Hover Hero</a></li>
						<li class="nav-item"><a class="nav-link" href="home-mega-text-video.html"><span
									class="sk__menu-icon"><span class="icon-cc-jcb"></span></span>Mega Text (Video)</a></li>
						<li class="nav-item"><a class="nav-link" href="home-parallax.html"><span class="sk__menu-icon"><span
										class="icon-clone"></span></span>Parallax Home</a></li>
						<li class="nav-item"><a class="nav-link" href="home-parallax-half-screens.html"><span
									class="sk__menu-icon"><span class="icon-object-ungroup"></span></span>Parallax
								Half-screens</a></li>
						<li class="nav-item"><a class="nav-link" href="home-mega-text-image.html"><span
									class="sk__menu-icon"><span class="icon-cc-jcb"></span></span>Mega Text (Image)</a></li>
						<li class="nav-item"><a class="nav-link" href="home-fullscreen-video.html"><span
									class="sk__menu-icon"><span class="icon-play-circle"></span></span>Full Screen Video</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="home-parallax-strips-hero.html"><span
									class="sk__menu-icon"><span class="icon-view_week"></span></span>Parallax Strips Hero</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="home-hero-slide-show.html"><span
									class="sk__menu-icon"><span class="icon-photo"></span></span>Hero Slide Show</a></li>
						<li class="nav-item"><a class="nav-link" href="home-animated-headline.html"><span
									class="sk__menu-icon"><span class="icon-play_arrow"></span></span>Animated Headline</a></li>
						<li class="nav-item"><a class="nav-link" href="home-hero-image.html"><span class="sk__menu-icon"><span
										class="icon-photo"></span></span>Hero Image</a></li>
						<li class="nav-item"><a class="nav-link" href="home-news.html"><span class="sk__menu-icon"><span
										class="icon-newspaper-o"></span></span>News Home</a></li>
						<li class="nav-item"><a class="nav-link" href="home-fullscreen-video-yt.html"><span
									class="sk__menu-icon"><span class="icon-youtube-play"></span></span>Full Screen Video
								(YT)</a></li>
						<li class="nav-item"><a class="nav-link" href="home-combo-light.html"><span class="sk__menu-icon"><span
				...
				<li class="nav-item menu-item-has-children">
					...
					<ul class="sk__submenu-ul">
						...
						<li class="nav-item"><a class="nav-link" href="page-services.html"><span class="sk__menu-icon"><span
										class="icon-th"></span></span>Services</a></li>
						<li class="nav-item"><a class="nav-link" href="page-service-item.html"><span class="sk__menu-icon"><span
										class="icon-codepen1"></span></span>Service or Product</a></li>
						<li class="nav-item"><a class="nav-link" href="page-portfolio.html"><span class="sk__menu-icon"><span
										class="icon-th"></span></span>Portfolio</a></li>
						<li class="nav-item"><a class="nav-link" href="page-portfolio-item.html"><span
									class="sk__menu-icon"><span class="icon-object-group"></span></span>Project - Parallax
								Gallery</a></li>
						<li class="nav-item"><a class="nav-link" href="page-portfolio-item-classic-gallery.html"><span
									class="sk__menu-icon"><span class="icon-photo"></span></span>Project - Classic Gallery</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="page-features.html"><span class="sk__menu-icon"><span
										class="icon-table2"></span></span>Features</a></li>
						<li class="nav-item"><a class="nav-link" href="page-news.html"><span class="sk__menu-icon"><span
										class="icon-list-alt"></span></span>News</a></li>
						<li class="nav-item"><a class="nav-link" href="page-news-item.html"><span class="sk__menu-icon"><span
										class="icon-file-text"></span></span>Article - Parallax Header</a></li>
						<li class="nav-item"><a class="nav-link" href="page-news-item-classic.html"><span
									class="sk__menu-icon"><span class="icon-file-text-o"></span></span>Article - Classic</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="page-contact-us.html"><span class="sk__menu-icon"><span
										class="icon-envelope-o"></span></span>Contact Us</a></li>
						<li class="nav-item"><a class="nav-link" href="page-coming-soon.html"><span class="sk__menu-icon"><span
										class="icon-access_time"></span></span>Coming Soon</a></li>
						<li class="nav-item"><a class="nav-link" href="page-404.html"><span class="sk__menu-icon"><span
										class="icon-warning"></span></span>404 Page</a></li>
						<li class="nav-item"><a class="nav-link" href="page-terms-and-conditions.html"><span
									class="sk__menu-icon"><span class="icon-library"></span></span>Terms and Conditions</a></li>
						<li class="nav-item"><a class="nav-link" href="page-privacy-policy.html"><span
					...
					<ul class="sk__submenu-ul">
						<li class="nav-item menu-item-has-children">
							...
							<ul class="sk__sub-submenu-ul">
								<li class="nav-item"><a class="nav-link" href="elements-gsap.html"><span
								...
								<li class="nav-item"><a class="nav-link" href="elements-forms.html"><span
											class="sk__menu-icon green sk__icon-popup"><span class="icon-usd"></span><span
												class="icon-usd"></span><span class="sk__icon-popup-text">Fully Working Forms!
												$14 Added Value</span></span>Contact Forms</a></li>
								<li class="nav-item"><a class="nav-link" href="elements-forms.html#subscribe-form"><span
											class="sk__menu-icon green sk__icon-popup"><span class="icon-usd"></span><span
												class="icon-usd"></span><span class="sk__icon-popup-text">Fully Working Forms!
												$14 Added Value</span></span>Subscribe Forms</a></li>
								<li class="nav-item"><a class="nav-link" href="elements-mockups.html"><span
											class="sk__menu-icon green sk__icon-popup"><span class="icon-usd"></span><span
						...
						<li class="nav-item menu-item-has-children">
							...
							<ul class="sk__sub-submenu-ul">
								<li class="nav-item"><a class="nav-link" href="elements-hero-combo-slider.html"><span
											class="sk__menu-icon"><span class="icon-codepen1"></span></span>Combo Slider</a>
								</li>
								<li class="nav-item"><a class="nav-link" href="elements-hero-fullscreen-video.html"><span
											class="sk__menu-icon"><span class="icon-play-circle"></span></span>Full Screen
										Video</a></li>
								<li class="nav-item"><a class="nav-link" href="elements-hero-fullscreen-video-yt.html"><span
											class="sk__menu-icon"><span class="icon-youtube-play"></span></span>Full Screen
										Video (YT)</a></li>
								<li class="nav-item"><a class="nav-link" href="elements-hero-slide-show.html"><span
											class="sk__menu-icon"><span class="icon-photo"></span></span>Hero Slide Show</a>
								</li>
								<li class="nav-item"><a class="nav-link" href="elements-hero-mega-text-video.html"><span
											class="sk__menu-icon"><span class="icon-cc-jcb"></span></span>Mega Text (Video)</a>
								</li>
								<li class="nav-item"><a class="nav-link" href="elements-hero-mega-text-image.html"><span
											class="sk__menu-icon"><span class="icon-cc-jcb"></span></span>Mega Text (Image)</a>
								</li>
								<li class="nav-item"><a class="nav-link" href="elements-hero-parallax-strips.html"><span
											class="sk__menu-icon"><span class="icon-view_week"></span></span>Parallax Strips
										Hero</a></li>
								<li class="nav-item"><a class="nav-link" href="elements-hero-animated-headline.html"><span
											class="sk__menu-icon"><span class="icon-play_arrow"></span></span>Animated Hero
										Headline</a></li>
								<li class="nav-item"><a class="nav-link" href="elements-hero-image.html"><span
											class="sk__menu-icon"><span class="icon-photo"></span></span>Hero Image</a></li>
							</ul>
						</li>
						<li class="nav-item menu-item-has-children">
							<a class="nav-link" href="elements-content.html"><span class="sk__menu-icon"><span
										class="icon-th"></span></span>Content Sections</a>
							<ul class="sk__sub-submenu-ul">
								<li><a class="nav-link" href="elements-content.html"><span class="sk__menu-icon"><span
												class="icon-th"></span></span>Content Sections</a></li>
								<li><a class="nav-link" href="elements-content.html#animated-counters-section"><span
											class="sk__menu-icon"><span class="icon-spinner1"></span></span>Animated
										Counters</a></li>
								<li><a class="nav-link" href="elements-content.html#cta-section"><span
											class="sk__menu-icon"><span class="icon-commenting-o"></span></span>Call To Action
										(CTA)</a></li>
								<li><a class="nav-link" href="elements-content.html#contact-section"><span
											class="sk__menu-icon"><span class="icon-envelope-open-o"></span></span>Contact
										Us</a></li>
								<li><a class="nav-link" href="elements-content.html#features-section"><span
											class="sk__menu-icon"><span class="icon-table2"></span></span>Features</a></li>
								<li><a class="nav-link" href="elements-content.html#icon-boxes-section"><span
											class="sk__menu-icon"><span class="icon-th"></span></span>Icon Boxes</a></li>
								<li><a class="nav-link" href="elements-content.html#image-boxes-section"><span
											class="sk__menu-icon"><span class="icon-th"></span></span>Image Boxes</a></li>
								<li><a class="nav-link" href="elements-content.html#partners-section"><span
											class="sk__menu-icon"><span class="icon-slideshare"></span></span>Partners</a></li>
								<li><a class="nav-link" href="elements-content.html#portfolio-section"><span
											class="sk__menu-icon"><span class="icon-th"></span></span>Portfolio</a></li>
								<li><a class="nav-link" href="elements-content.html#skills-section"><span
											class="sk__menu-icon"><span class="icon-server"></span></span>Skills</a></li>
								<li><a class="nav-link" href="elements-content.html#testimonials-section"><span
											class="sk__menu-icon"><span class="icon-comments"></span></span>Testimonials</a>
								</li>
							</ul>
						</li>
						<li class="nav-item menu-item-has-children">
							<a class="nav-link" href="elements-parallax-content.html"><span class="sk__menu-icon"><span
										class="icon-codepen1"></span></span>Parallax Sections</a>
							<ul class="sk__sub-submenu-ul">
								<li><a class="nav-link" href="elements-parallax-content.html"><span class="sk__menu-icon"><span
												class="icon-codepen1"></span></span>Parallax Sections</a></li>
								<li><a class="nav-link" href="elements-parallax-content.html#about-us-section"><span
											class="sk__menu-icon"><span class="icon-id-card-o"></span></span>About Us
										(Parallax)</a></li>
								<li><a class="nav-link" href="elements-parallax-content.html#animated-counters-section"><span
											class="sk__menu-icon"><span class="icon-spinner1"></span></span>Anim. Counters
										(Parallax)</a></li>
								<li><a class="nav-link" href="elements-parallax-content.html#cta-parallax-section"><span
											class="sk__menu-icon"><span class="icon-commenting-o"></span></span>CTA Section
										(Parallax)</a></li>
								<li><a class="nav-link" href="elements-parallax-content.html#contact-parallax-section"><span
											class="sk__menu-icon"><span class="icon-envelope-o"></span></span>Contact Us
										(Parallax)</a></li>
								<li><a class="nav-link" href="elements-parallax-content.html#featured-project-section"><span
											class="sk__menu-icon"><span class="icon-photo"></span></span>Featured Project</a>
								</li>
								<li><a class="nav-link" href="elements-parallax-content.html#features-parallax-section"><span
											class="sk__menu-icon"><span class="icon-object-ungroup"></span></span>Features
										(Parallax)</a></li>
								<li><a class="nav-link" href="elements-parallax-content.html#icon-boxes-parallax-section"><span
											class="sk__menu-icon"><span class="icon-th"></span></span>Icon Boxes (Parallax)</a>
								</li>
								<li><a class="nav-link" href="elements-parallax-content.html#image-boxes-parallax-section"><span
											class="sk__menu-icon"><span class="icon-th"></span></span>Image Boxes (Parallax)</a>
								</li>
								<li><a class="nav-link" href="elements-parallax-content.html#laptop-section"><span
											class="sk__menu-icon"><span class="icon-laptop1"></span></span>Laptop Section</a>
								</li>
								<li><a class="nav-link" href="elements-parallax-content.html#parallax-text-section"><span
											class="sk__menu-icon"><span class="icon-clone"></span></span>Parallax Text</a></li>
								<li><a class="nav-link" href="elements-parallax-content.html#parallax-images-section"><span
											class="sk__menu-icon"><span class="icon-object-ungroup"></span></span>Parallax
										Images</a></li>
								<li><a class="nav-link" href="elements-parallax-content.html#parallax-videos-section"><span
											class="sk__menu-icon"><span class="icon-ondemand_video"></span></span>Parallax
										Video</a></li>
								<li><a class="nav-link" href="elements-parallax-content.html#partners-parallax-section"><span
											class="sk__menu-icon"><span class="icon-slideshare"></span></span>Partners</a></li>
								<li><a class="nav-link" href="elements-parallax-content.html#rings-section"><span
											class="sk__menu-icon"><span class="icon-bullseye"></span></span>Rings Section</a>
								</li>
								<li><a class="nav-link" href="elements-parallax-content.html#skills-parallax-section"><span
											class="sk__menu-icon"><span class="icon-server"></span></span>Skills (Parallax)</a>
								</li>
								<li><a class="nav-link"
										href="elements-parallax-content.html#testimonials-parallax-section"><span
						...
						<li class="nav-item menu-item-has-children">
							...
							<ul class="sk__sub-submenu-ul">
								<li><a class="nav-link" href="elements-galleries.html#classic-gallery"><span
											class="sk__menu-icon"><span class="icon-photo"></span></span>Classic Gallery</a>
								</li>
								<li><a class="nav-link" href="elements-galleries.html#gallery-section"><span
											class="sk__menu-icon"><span class="icon-newspaper-o"></span></span>Gallery
										Section</a></li>
								<li><a class="nav-link" href="elements-galleries.html#parallax-gallery"><span
						...
						<li class="nav-item menu-item-has-children">
							...
							<ul class="sk__sub-submenu-ul">
								<li class="nav-item"><a class="nav-link" href="elements-footer-simple.html"><span
											class="sk__menu-icon"><span class="icon-square"></span></span>Footer - Simple</a>
								</li>
								<li class="nav-item"><a class="nav-link" href="elements-footer-full.html"><span
											class="sk__menu-icon"><span class="icon-table2"></span></span>Footer - Full</a></li>
							</ul>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="elements-typography.html"><span class="sk__menu-icon"><span
										class="icon-font1"></span></span>Typography</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="elements-icon-fonts.html"><span class="sk__menu-icon"><span
				...
				<li class="nav-item">
					<a class="nav-link hvr-underline-from-center" href="theme-preview.html#demo-select"><span
